...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CountryVATCheckers; });
class CountryVATCheckers {
  ...
  CHEVATCheckDigit(vatnumber) {
    ...
    let total = 0;
    for (let i = 0; i < 8; i++) total += Number(vatnumber.charAt(i)) * multipliers[i];
  ...
  FIVATCheckDigit(vatnumber) {
    ...
    // Extract the next digit and multiply by the counter.
    for (let i = 0; i < 7; i++) total += Number(vatnumber.charAt(i)) * multipliers[i];
  ...
  LVVATCheckDigit(vatnumber) {
    ...
    if (/^[0-3]/.test(vatnumber)) {
      ...
      // Extract the next digit and multiply by the counter.
      for (let i = 0; i < 10; i++) total += Number(vatnumber.charAt(i)) * multipliers[i];
  ...
  MTVATCheckDigit(vatnumber) {
    ...
    // Extract the next digit and multiply by the counter.
    for (let i = 0; i < 6; i++) total += Number(vatnumber.charAt(i)) * multipliers[i];
  ...
  PLVATCheckDigit(vatnumber) {
    ...
    // Extract the next digit and multiply by the counter.
    for (let i = 0; i < 9; i++) total += Number(vatnumber.charAt(i)) * multipliers[i];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VatValidator; });
/* harmony import */ var _CountryVATCheckers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CountryVATCheckers */ "./src/CountryVATCheckers.js");
...
class VatValidator {
  ...
  validate(toCheck) {
    ...
    const countryVatCheckers = new _CountryVATCheckers__WEBPACK_IMPORTED_MODULE_0__["default"]();

    return vatexp.filter(regexp => regexp.test(VATNumber)).map(regexp => {
...
//# sourceMappingURL=eu-vat-validation.js.map